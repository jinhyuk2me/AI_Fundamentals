...
### 학습 패러다임 깊이 이해
- [[ML Foundations/1. 학습 패러다임]]: 각 패러다임의 상세 설명과 실습

### 딥러닝 아키텍처 학습
- [[Foundations/5. 신경망 기본 구조]]: MLP, 역전파 이해
- [[Foundations/8. 합성곱 신경망 기초]]: CNN 아키텍처
- [[Foundations/9. 시퀀스 모델 기초]]: RNN, Transformer

### 전체 로드맵
- [[AI 기초 개요]]: 이 저장소의 전체 학습 로드맵
